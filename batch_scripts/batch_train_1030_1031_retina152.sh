...
python main.py --purpose train    --env 1030-joint-puppet-close-up-wounds                                       --gpu_no 1 --batch_size=2 --net_type retina-resnet152 --data_dir=/home/samuelblattner/projects/ffhs-bachelor-thesis-wound-detection/data/vanilla_datasets --checkpoint_dir=/checkpoints > train-1030-retina152.log 2>&1
python main.py --purpose evaluate --env 1030-joint-puppet-close-up-wounds                                       --gpu_no 1 --batch_size=2 --net_type retina-resnet152 --data_dir=/home/samuelblattner/projects/ffhs-bachelor-thesis-wound-detection/data/vanilla_datasets --checkpoint_dir=/checkpoints --eval_dir=/checkpoints/evaluation                                     --eval_images --eval_heatmaps
python main.py --purpose evaluate --env 1030-joint-puppet-close-up-wounds-body-shots-eval                       --gpu_no 1 --batch_size=2 --net_type retina-resnet152 --data_dir=/home/samuelblattner/projects/ffhs-bachelor-thesis-wound-detection/data/vanilla_datasets --checkpoint_dir=/checkpoints --eval_dir=/checkpoints/evaluation --eval_name_suffix=-body-shots-eval --eval_images --eval_heatmaps
python main.py --purpose evaluate --env 1030-joint-puppet-close-up-wounds-cases-eval                            --gpu_no 1 --batch_size=2 --net_type retina-resnet152 --data_dir=/home/samuelblattner/projects/ffhs-bachelor-thesis-wound-detection/data/vanilla_datasets --checkpoint_dir=/checkpoints --eval_dir=/checkpoints/evaluation --eval_name_suffix=-cases-eval      --eval_images --eval_heatmaps
...
python main.py --purpose train    --env 1031-joint-puppet-close-up-wounds-fine-tuning                           --gpu_no 1 --batch_size=2 --net_type retina-resnet152 --data_dir=/home/samuelblattner/projects/ffhs-bachelor-thesis-wound-detection/data/vanilla_datasets --checkpoint_dir=/checkpoints > train-1031-retina152.log 2>&1
python main.py --purpose evaluate --env 1031-joint-puppet-close-up-wounds-fine-tuning                           --gpu_no 1 --batch_size=2 --net_type retina-resnet152 --data_dir=/home/samuelblattner/projects/ffhs-bachelor-thesis-wound-detection/data/vanilla_datasets --checkpoint_dir=/checkpoints --eval_dir=/checkpoints/evaluation                                     --eval_images --eval_heatmaps
python main.py --purpose evaluate --env 1031-joint-puppet-close-up-wounds-fine-tuning-body-shots-eval           --gpu_no 1 --batch_size=2 --net_type retina-resnet152 --data_dir=/home/samuelblattner/projects/ffhs-bachelor-thesis-wound-detection/data/vanilla_datasets --checkpoint_dir=/checkpoints --eval_dir=/checkpoints/evaluation --eval_name_suffix=-body-shots-eval --eval_images --eval_heatmaps
python main.py --purpose evaluate --env 1031-joint-puppet-close-up-wounds-fine-tuning-cases-eval                --gpu_no 1 --batch_size=2 --net_type retina-resnet152 --data_dir=/home/samuelblattner/projects/ffhs-bachelor-thesis-wound-detection/data/vanilla_datasets --checkpoint_dir=/checkpoints --eval_dir=/checkpoints/evaluation --eval_name_suffix=-cases-eval      --eval_images --eval_heatmaps