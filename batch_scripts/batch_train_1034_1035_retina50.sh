...
#python main.py --purpose train    --env 1030-joint-puppet-close-up-wounds                                       --gpu_no 0 --net_type retina-resnet50 --data_dir=/home/samuelblattner/projects/ffhs-bachelor-thesis-wound-detection/data/vanilla_datasets --checkpoint_dir=/checkpoints/ --eval_dir=/checkpoints/evaluation > train-1030-retina50.log 2>&1
